...
CREATE TABLE `campionato` (
  `cod_campionato` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(20) NOT NULL,
  `stagione` varchar(9) NOT NULL,
  `squadra_vincente` varchar(20) NOT NULL,
  PRIMARY KEY (`cod_campionato`),
  KEY `vinto` (`squadra_vincente`),
  CONSTRAINT `vinto` FOREIGN KEY (`squadra_vincente`) REFERENCES `squadra` (`nome`)
...
INSERT INTO `campionato` VALUES (1,'Serie A','2018/2019','Juventus'),(2,'Serie A','2017/2018','Juventus'),(3,'Serie A','2016/2017','Juventus');
